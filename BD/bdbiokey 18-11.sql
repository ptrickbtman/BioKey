...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-11-2020 a las 20:46:20
...
--
ALTER TABLE `registros_cerr`
  MODIFY `ID_REGIS` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `tipo_registro`
  MODIFY `ID_TIPREGIS` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `usuarios`
  MODIFY `ID_USU` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
