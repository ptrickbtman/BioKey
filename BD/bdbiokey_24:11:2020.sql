...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-11-2020 a las 16:37:39
...
(1, 1, 'aaaa-aaaa-aaaa-aaaa', '132354', '19-11-2020 23:00', '1', 'biron', '123456789'),
(2, 1, 'bbbb-bbbb-bbbb-bbbb', '1234568', '19-11-2020 23:33', '1', 'bastian', '');
...
--
ALTER TABLE `boletas`
  MODIFY `ID_BOL` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `cerraduras`
--
ALTER TABLE `cerraduras`
  MODIFY `COD_CERR` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `direccion`
  MODIFY `ID_DIR` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `registros_cerr`
  MODIFY `ID_REGIS` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
